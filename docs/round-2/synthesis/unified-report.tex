...
Which can be inferred without surprising the author?
...
entailment-based certificate reuse across changed requests.
...
adequacy theorem for any proposed promotion between them.
...
productivity result or end-to-end language implementation is claimed.
